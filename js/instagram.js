var Instagram = (function(){
	...
	return {
		init:function(){
            ...
            var access_token="3013921362.1c86b45.2022ba6fe1b34b3d9280e3ef3a124bad"
			if(!insid){
			...
			getList("https://api.instagram.com/v1/users/"+ userId +"/media/recent/?client_id="+insid+"&count=100&access_token="+access_token);
			bind();
		}
	}
})();
